...
wordscomp <- sort(rowSums(matrix),decreasing = TRUE) 

dfcomp <- data.frame(word = names(words), freq = words)

# Wordcloud
wordcloud2(data = dfcomp, size = 2, color= "random-light", shape = "circle", backgroundColor = "black")
...
dfperson <- data.frame(word = names(words), freq = words)
