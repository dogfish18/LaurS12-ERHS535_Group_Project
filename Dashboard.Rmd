...
### Primary Types of Voice Interactions with Computer

```{r}
startrek$char <- as.factor(startrek$char)
startrek$type <- as.factor(startrek$type)
startrek$nv_resp <- as.factor(startrek$nv_resp)

startrek$nv_resp <- startrek$nv_resp %>% 
