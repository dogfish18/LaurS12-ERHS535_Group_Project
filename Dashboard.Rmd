...
### Chart 2: Character Voice Interactions with Entertainment Computers
...
The holodeck is a 3D simiulation room, "music" is when a character requests the computer to play music, and "replicator" is a device the character can use to create food or drink (similar to a 3D food printer). 
