...
Because the computer on the Starship Enterprise can generate objects and display information without responding, it is of interest to examine the proportion of occurrences when the computer responds non-verbally or with actions (versus with 'By Computer' interactions). The visualization to the left shows frequency of each interaction type by person, and frequency of subsequent interaction by computer via verbal and non-verbal response rates.
